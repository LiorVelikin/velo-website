...
const socials = [
  { name: 'Instagram', icon: <InstagramIcon />, href: 'https://www.instagram.com/lior_velo/' },
  { name: 'Facebook',  icon: <FacebookIcon />,  href: 'https://www.facebook.com/Lior.Velo.Digital/' },
  { name: 'LinkedIn',  icon: <LinkedInIcon />,  href: 'https://www.linkedin.com/in/lior-velikin-2784332b7/' },
]
      ...
      <div style={{ maxWidth: 1280, margin: '0 auto', padding: 'clamp(48px,6vw,80px) clamp(16px,4vw,48px) 40px' }}>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: 'clamp(32px, 4vw, 56px)', marginBottom: 56 }}>
          ...
          <div>
            ...
            <p style={{ color: 'rgba(255,255,255,0.4)', fontSize: '0.83rem', lineHeight: 1.65, marginBottom: 24, maxWidth: 220 }}>
              בונים עסקים דיגיטליים מאפס ועד תוצאות. מעטפת שיווק מלאה תחת קורת גג אחת.
            </p>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12, marginBottom: 28 }}>
              {[
                ...
                <div key={i} style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                  <div style={{ color: '#4d9fff', flexShrink: 0, opacity: 0.7 }}>{item.icon}</div>
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between', alignItems: 'center', gap: 8, paddingBottom: 8 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 7 }}>
            <div style={{ width: 6, height: 6, borderRadius: '50%', background: '#00d4ff', boxShadow: '0 0 6px #00d4ff', animation: 'orbPulse 2s ease-in-out infinite' }} />
