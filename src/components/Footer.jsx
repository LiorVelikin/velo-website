...
const navLinks = [
  ...
  { label: 'איך אנחנו עובדים', href: '#process'     },
  { label: 'עבודות ותוצאות',   href: '#results-flow'},
...
const contactItems = [
  {
    icon: (
      <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor"
        ...
        <path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 11.08 19.79 19.79 0 01.04 2.38 2 2 0 012 .22h3a2 2 0 012 1.72c.127.96.361 1.903.7 2.81a2 2 0 01-.45 2.11L6.91 7.91a16 16 0 006.08 6.08l1.28-1.28a2 2 0 012.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0122 14.92v2z"/>
      </svg>
    ),
    text: '050-0000000',
  },
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div>
            ...
            <p style={{ color: 'rgba(255,255,255,0.4)', fontSize: '0.83rem', lineHeight: 1.65, marginBottom: 24, maxWidth: 220 }}>
              אנחנו בונים עסקים דיגיטליים מאפס ועד תוצאות.
            </p>
            {/* Socials */}
              ...
              {socials.map(s => (
                <a
                  ...
                  onMouseEnter={e => {
                    ...
                    e.currentTarget.style.background = 'rgba(26,111,255,0.12)'
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12, marginBottom: 28 }}>
              {contactItems.map((item, i) => (
                <div key={i} style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                  <span style={{ color: '#4d9fff', flexShrink: 0 }}>{item.icon}</span>
                  <span style={{ color: 'rgba(255,255,255,0.5)', fontSize: '0.85rem' }}>{item.text}</span>
                </div>
              ))}
            </div>
            {/* Mini CTA */}
            <p style={{ color: 'rgba(255,255,255,0.55)', fontSize: '0.82rem', marginBottom: 12, fontWeight: 600 }}>
              רוצים לדבר עכשיו?
            </p>
            <a href="#contact">
        ...
        <div style={{
          ...
          <p style={{ color: 'rgba(255,255,255,0.22)', fontSize: '0.72rem' }}>
            © 2026 VELO Studio. כל הזכויות שמורות.
          </p>
      ...
      <div style={{ position: 'relative', overflow: 'hidden', lineHeight: 0 }}>
        <div
          style={{
            ...
            lineHeight: 0.9,
            background: 'linear-gradient(180deg, rgba(26,111,255,0.09) 0%, rgba(0,212,255,0.025) 60%, transparent 100%)',
