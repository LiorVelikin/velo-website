          ...
          <div className="grid-cols-2" style={{ gap: 24 }}>
            {seoServices.map((s, i) => (
              ...
              >
                ...
                <h3 style={{ color: 'var(--ink-100)', fontWeight: 700, fontSize: '1.1rem', marginBottom: 10 }}>{s.title}</h3>
                <p style={{ color: 'var(--ink-300)', fontSize: '0.9rem', lineHeight: 1.7, margin: 0 }}>{s.desc}</p>
              </div>
            ))}
          </div>
        </div>
