...
const trustItems = [
  { icon: <ShieldIcon />, color: '#22D3EE', title: 'ללא התחייבות', desc: 'האבחון שלנו הוא שלכם, תעשו איתו מה שתרצו.' },
  { icon: <StarIcon />,   color: '#3D8BFF', title: 'ייעוץ אמיתי',   desc: 'שיחה עם ליאור ישירות — לא עם מוקד מכירות.' },
  { icon: <ZapIcon />,   color: '#22D3EE', title: 'מחזירים מהר',   desc: 'בדרך כלל בתוך כמה שעות, לכל היותר יום עסקים.' },
]
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 'clamp(32px,5vw,64px)', alignItems: 'flex-start' }}>
            ...
            <div style={{ flex: '1 1 360px', minWidth: 0 }}>
              ...
              <p style={{ color: 'var(--ink-300)', fontSize: '0.95rem', marginBottom: 28, lineHeight: 1.65 }}>
            ...
            <div style={{ flex: '1 1 280px', minWidth: 0, paddingTop: 8 }}>
              <div style={{ marginBottom: 40 }}>
                <h3 style={{ color: 'var(--ink-100)', fontWeight: 700, fontSize: '1rem', marginBottom: 20 }}>למה כדאי לדבר איתנו?</h3>
                <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
                  {trustItems.map((item, i) => (
                    <div key={i} style={{ display: 'flex', gap: 14, alignItems: 'flex-start' }}>
                      ...
                      <div>
                        <p style={{ color: 'var(--ink-100)', fontWeight: 700, fontSize: '0.9rem', marginBottom: 3 }}>{item.title}</p>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                <h3 style={{ color: 'var(--ink-100)', fontWeight: 700, fontSize: '1rem', marginBottom: 6 }}>פרטי יצירת קשר</h3>
                {[
                  ...
                  <div key={i} style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                    ...
                    <div>
                      ...
                      <span style={{ color: 'var(--ink-100)', fontSize: '0.88rem' }}>{item.text}</span>
                    </div>
                  </div>
                ))}
              </div>
              ...
              <div style={{ marginTop: 28, padding: '16px 20px', borderRadius: 12, background: 'rgba(26,111,255,0.07)', border: '1px solid rgba(26,111,255,0.18)' }}>
                <p style={{ color: 'var(--ink-300)', fontSize: '0.78rem', marginBottom: 4, fontWeight: 600 }}>מקבלים לקוחות חדשים?</p>
